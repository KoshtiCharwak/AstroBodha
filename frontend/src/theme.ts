...
// Editorial serif used for the "ZODIAC" wordmark and hero headlines only.
// Body copy, inputs and labels always use the system sans-serif font.
export const fontSerif = Platform.select({ ios: "Georgia", android: "serif", default: "Georgia" });

export type ColorScheme = "light" | "dark";

const light = {
  // ---------------------------------------------------------------------------
  // Surfaces: ZODIAC cosmic-luxury theme is a single always-dark theme (no
  // light/dark toggle). Values below come from /app/design_guidelines.json.
  // ---------------------------------------------------------------------------
  surface: "#080816", // primary canvas, deep cosmic navy/black
  onSurface: "#FFFFFF", // text and icons on the canvas
  surfaceSecondary: "#181438", // cards, sheets, list rows
  onSurfaceSecondary: "#E9E6F5", // text and icons on cards, sheets, rows
  surfaceTertiary: "#110E29", // input backgrounds, chips, deepest nesting
  ...
  onSurfaceInverse: "#181438", // text and icons on the inverse surface
  muted: "#9CA3AF", // subdued text on surface: captions, timestamps, placeholders

  // ---------------------------------------------------------------------------
  // Brand: violet/purple cosmic accent used for links, headline highlights,
  // active states. Gold is the separate premium accent (see below).
  // ---------------------------------------------------------------------------
  brand: "#9333EA", // base hue, anchor only; Primary, Secondary, Tertiary are weights of it
  onBrand: "#FFFFFF", // text and icons placed directly on brand
  brandPrimary: "#9333EA", // primary CTA, active tab indicator, selected states
  onBrandPrimary: "#FFFFFF", // text and icons on brandPrimary
  brandSecondary: "#2E285C", // secondary CTA, less prominent accents
  onBrandSecondary: "#FFFFFF", // text and icons on brandSecondary
  brandTertiary: "#C084FC", // chips, tags, badges, subtle brand moments
  onBrandTertiary: "#1F1B3A", // text and icons on brandTertiary
  ...
  // Lines
  // ---------------------------------------------------------------------------
  border: "#2E285C", // hairline outline, 0.5pt or 1pt max: inputs, cards
  borderStrong: "#C084FC", // focus rings, selected outlines, 1.5pt max
  divider: "#241F47", // subtle list separators

  // ---------------------------------------------------------------------------
  // ZODIAC extras: gold premium accent + prediction category colors.
  // ---------------------------------------------------------------------------
  gold: "#F59E0B",
  goldGlow: "#FBBF24",
  goldDark: "#B45309",
